...
impl Gist {
  ...
  pub fn with_comments(mut self, comments: i32) -> Gist {
    self.comments = Some(comments);
    self
  }
  ...
  pub fn with_comments_url(mut self, comments_url: String) -> Gist {
    self.comments_url = Some(comments_url);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> Gist {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> Gist {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_files(mut self, files: ::models::GistFiles) -> Gist {
    self.files = Some(files);
    self
  }
  ...
  pub fn set_forks(&mut self, forks: Vec<::models::GistForks>) {
    self.forks = Some(forks);
  }

  pub fn with_forks(mut self, forks: Vec<::models::GistForks>) -> Gist {
    self.forks = Some(forks);
    self
  }

  pub fn forks(&self) -> Option<&Vec<::models::GistForks>> {
    self.forks.as_ref()
  }
  ...
  pub fn with_git_pull_url(mut self, git_pull_url: String) -> Gist {
    self.git_pull_url = Some(git_pull_url);
    self
  }
  ...
  pub fn with_git_push_url(mut self, git_push_url: String) -> Gist {
    self.git_push_url = Some(git_push_url);
    self
  }
  ...
  pub fn set_history(&mut self, history: Vec<::models::GistHistory>) {
    self.history = Some(history);
  }

  pub fn with_history(mut self, history: Vec<::models::GistHistory>) -> Gist {
    self.history = Some(history);
    self
  }

  pub fn history(&self) -> Option<&Vec<::models::GistHistory>> {
    self.history.as_ref()
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> Gist {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> Gist {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_public(mut self, public: bool) -> Gist {
    self.public = Some(public);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> Gist {
    self.url = Some(url);
    self
  }
  ...
  pub fn with_user(mut self, user: ::models::BranchCommitAuthor) -> Gist {
    self.user = Some(user);
    self
  }
