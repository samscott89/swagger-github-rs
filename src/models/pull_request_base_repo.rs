...
impl PullRequestBaseRepo {
  pub fn new() -> PullRequestBaseRepo {
    PullRequestBaseRepo {
      clone_url: None,
      created_at: None,
      description: None,
  ...
  pub fn with_clone_url(mut self, clone_url: String) -> PullRequestBaseRepo {
    self.clone_url = Some(clone_url);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> PullRequestBaseRepo {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> PullRequestBaseRepo {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_fork(mut self, fork: bool) -> PullRequestBaseRepo {
    self.fork = Some(fork);
    self
  }
  ...
  pub fn with_forks(mut self, forks: i32) -> PullRequestBaseRepo {
    self.forks = Some(forks);
    self
  }
  ...
  pub fn with_forks_count(mut self, forks_count: i32) -> PullRequestBaseRepo {
    self.forks_count = Some(forks_count);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> PullRequestBaseRepo {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_git_url(mut self, git_url: String) -> PullRequestBaseRepo {
    self.git_url = Some(git_url);
    self
  }
  ...
  pub fn with_homepage(mut self, homepage: String) -> PullRequestBaseRepo {
    self.homepage = Some(homepage);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> PullRequestBaseRepo {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> PullRequestBaseRepo {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_master_branch(mut self, master_branch: String) -> PullRequestBaseRepo {
    self.master_branch = Some(master_branch);
    self
  }
  ...
  pub fn with_mirror_url(mut self, mirror_url: String) -> PullRequestBaseRepo {
    self.mirror_url = Some(mirror_url);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> PullRequestBaseRepo {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_open_issues(mut self, open_issues: i32) -> PullRequestBaseRepo {
    self.open_issues = Some(open_issues);
    self
  }
  ...
  pub fn with_open_issues_count(mut self, open_issues_count: i32) -> PullRequestBaseRepo {
    self.open_issues_count = Some(open_issues_count);
    self
  }
  ...
  pub fn with_owner(mut self, owner: ::models::BranchCommitAuthor) -> PullRequestBaseRepo {
    self.owner = Some(owner);
    self
  }
  ...
  pub fn with_private(mut self, private: bool) -> PullRequestBaseRepo {
    self.private = Some(private);
    self
  }
  ...
  pub fn with_pushed_at(mut self, pushed_at: String) -> PullRequestBaseRepo {
    self.pushed_at = Some(pushed_at);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> PullRequestBaseRepo {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_ssh_url(mut self, ssh_url: String) -> PullRequestBaseRepo {
    self.ssh_url = Some(ssh_url);
    self
  }
  ...
  pub fn with_svn_url(mut self, svn_url: String) -> PullRequestBaseRepo {
    self.svn_url = Some(svn_url);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> PullRequestBaseRepo {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> PullRequestBaseRepo {
    self.url = Some(url);
    self
  }
  ...
  pub fn with_watchers(mut self, watchers: i32) -> PullRequestBaseRepo {
    self.watchers = Some(watchers);
    self
  }
  ...
  pub fn with_watchers_count(mut self, watchers_count: i32) -> PullRequestBaseRepo {
    self.watchers_count = Some(watchers_count);
    self
  }
