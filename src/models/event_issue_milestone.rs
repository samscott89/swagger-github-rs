...
pub struct EventIssueMilestone {
...
impl EventIssueMilestone {
  pub fn new() -> EventIssueMilestone {
    EventIssueMilestone {
      closed_issues: None,
      created_at: None,
      creator: None,
  ...
  pub fn with_closed_issues(mut self, closed_issues: i32) -> EventIssueMilestone {
    self.closed_issues = Some(closed_issues);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> EventIssueMilestone {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_creator(mut self, creator: ::models::BranchCommitAuthor) -> EventIssueMilestone {
    self.creator = Some(creator);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> EventIssueMilestone {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_due_on(mut self, due_on: String) -> EventIssueMilestone {
    self.due_on = Some(due_on);
    self
  }
  ...
  pub fn with_number(mut self, number: i32) -> EventIssueMilestone {
    self.number = Some(number);
    self
  }
  ...
  pub fn with_open_issues(mut self, open_issues: i32) -> EventIssueMilestone {
    self.open_issues = Some(open_issues);
    self
  }
  ...
  pub fn with_state(mut self, state: ::models::ErrorUnknown) -> EventIssueMilestone {
    self.state = Some(state);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> EventIssueMilestone {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> EventIssueMilestone {
    self.url = Some(url);
    self
  }
