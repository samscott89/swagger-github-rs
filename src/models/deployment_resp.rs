...
impl DeploymentResp {
  ...
  pub fn with_created_at(mut self, created_at: String) -> DeploymentResp {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_creator(mut self, creator: ::models::ComparecommitsBaseCommitAuthor) -> DeploymentResp {
    self.creator = Some(creator);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> DeploymentResp {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> DeploymentResp {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_payload(mut self, payload: String) -> DeploymentResp {
    self.payload = Some(payload);
    self
  }
  ...
  pub fn with_sha(mut self, sha: String) -> DeploymentResp {
    self.sha = Some(sha);
    self
  }
  ...
  pub fn with_statuses_url(mut self, statuses_url: String) -> DeploymentResp {
    self.statuses_url = Some(statuses_url);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> DeploymentResp {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> DeploymentResp {
    self.url = Some(url);
    self
  }
