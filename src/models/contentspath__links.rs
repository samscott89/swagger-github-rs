...
impl ContentspathLinks {
  pub fn new() -> ContentspathLinks {
    ContentspathLinks {
      git: None,
      html: None,
      _self: None
  ...
  pub fn with_git(mut self, git: String) -> ContentspathLinks {
    self.git = Some(git);
    self
  }
  ...
  pub fn with_html(mut self, html: String) -> ContentspathLinks {
    self.html = Some(html);
    self
  }
  ...
  pub fn with__self(mut self, _self: String) -> ContentspathLinks {
    self._self = Some(_self);
    self
  }
