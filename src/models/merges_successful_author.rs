...
pub struct MergesSuccessfulAuthor {
...
impl MergesSuccessfulAuthor {
  pub fn new() -> MergesSuccessfulAuthor {
  ...
  pub fn with_avatar_url(mut self, avatar_url: String) -> MergesSuccessfulAuthor {
    self.avatar_url = Some(avatar_url);
    self
  }
  ...
  pub fn with_events_url(mut self, events_url: String) -> MergesSuccessfulAuthor {
    self.events_url = Some(events_url);
    self
  }
  ...
  pub fn with_followers_url(mut self, followers_url: String) -> MergesSuccessfulAuthor {
    self.followers_url = Some(followers_url);
    self
  }
  ...
  pub fn with_following_url(mut self, following_url: String) -> MergesSuccessfulAuthor {
    self.following_url = Some(following_url);
    self
  }
  ...
  pub fn with_gists_url(mut self, gists_url: String) -> MergesSuccessfulAuthor {
    self.gists_url = Some(gists_url);
    self
  }
  ...
  pub fn with_gravatar_id(mut self, gravatar_id: String) -> MergesSuccessfulAuthor {
    self.gravatar_id = Some(gravatar_id);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> MergesSuccessfulAuthor {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> MergesSuccessfulAuthor {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_login(mut self, login: String) -> MergesSuccessfulAuthor {
    self.login = Some(login);
    self
  }
  ...
  pub fn with_organizations_url(mut self, organizations_url: String) -> MergesSuccessfulAuthor {
    self.organizations_url = Some(organizations_url);
    self
  }
  ...
  pub fn with_received_events_url(mut self, received_events_url: String) -> MergesSuccessfulAuthor {
    self.received_events_url = Some(received_events_url);
    self
  }
  ...
  pub fn with_repos_url(mut self, repos_url: String) -> MergesSuccessfulAuthor {
    self.repos_url = Some(repos_url);
    self
  }
  ...
  pub fn with_starred_url(mut self, starred_url: String) -> MergesSuccessfulAuthor {
    self.starred_url = Some(starred_url);
    self
  }
  ...
  pub fn with_subscriptions_url(mut self, subscriptions_url: String) -> MergesSuccessfulAuthor {
    self.subscriptions_url = Some(subscriptions_url);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> MergesSuccessfulAuthor {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> MergesSuccessfulAuthor {
    self.url = Some(url);
    self
  }
