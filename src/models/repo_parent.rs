...
impl RepoParent {
  ...
  pub fn with_clone_url(mut self, clone_url: String) -> RepoParent {
    self.clone_url = Some(clone_url);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> RepoParent {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> RepoParent {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_fork(mut self, fork: bool) -> RepoParent {
    self.fork = Some(fork);
    self
  }
  ...
  pub fn with_forks(mut self, forks: i32) -> RepoParent {
    self.forks = Some(forks);
    self
  }
  ...
  pub fn with_forks_count(mut self, forks_count: i32) -> RepoParent {
    self.forks_count = Some(forks_count);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> RepoParent {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_git_url(mut self, git_url: String) -> RepoParent {
    self.git_url = Some(git_url);
    self
  }
  ...
  pub fn with_homepage(mut self, homepage: String) -> RepoParent {
    self.homepage = Some(homepage);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> RepoParent {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> RepoParent {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_language(mut self, language: String) -> RepoParent {
    self.language = Some(language);
    self
  }
  ...
  pub fn with_master_branch(mut self, master_branch: String) -> RepoParent {
    self.master_branch = Some(master_branch);
    self
  }
  ...
  pub fn with_mirror_url(mut self, mirror_url: String) -> RepoParent {
    self.mirror_url = Some(mirror_url);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RepoParent {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_open_issues(mut self, open_issues: i32) -> RepoParent {
    self.open_issues = Some(open_issues);
    self
  }
  ...
  pub fn with_open_issues_count(mut self, open_issues_count: i32) -> RepoParent {
    self.open_issues_count = Some(open_issues_count);
    self
  }
  ...
  pub fn with_owner(mut self, owner: ::models::BranchCommitAuthor) -> RepoParent {
    self.owner = Some(owner);
    self
  }
  ...
  pub fn with_private(mut self, private: bool) -> RepoParent {
    self.private = Some(private);
    self
  }
  ...
  pub fn with_pushed_at(mut self, pushed_at: String) -> RepoParent {
    self.pushed_at = Some(pushed_at);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> RepoParent {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_ssh_url(mut self, ssh_url: String) -> RepoParent {
    self.ssh_url = Some(ssh_url);
    self
  }
  ...
  pub fn with_svn_url(mut self, svn_url: String) -> RepoParent {
    self.svn_url = Some(svn_url);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> RepoParent {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> RepoParent {
    self.url = Some(url);
    self
  }
  ...
  pub fn with_watchers(mut self, watchers: i32) -> RepoParent {
    self.watchers = Some(watchers);
    self
  }
  ...
  pub fn with_watchers_count(mut self, watchers_count: i32) -> RepoParent {
    self.watchers_count = Some(watchers_count);
    self
  }
