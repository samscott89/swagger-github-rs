...
impl Release {
  ...
  pub fn with_assets(mut self, assets: Vec<::models::ReleaseAssets>) -> Release {
    self.assets = Some(assets);
    self
  }
  ...
  pub fn with_assets_url(mut self, assets_url: String) -> Release {
    self.assets_url = Some(assets_url);
    self
  }
  ...
  pub fn with_author(mut self, author: ::models::ComparecommitsBaseCommitAuthor) -> Release {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> Release {
    self.id = Some(id);
    self
  }
