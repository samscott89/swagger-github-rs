...
pub struct ReleasesInner {
  #[serde(rename = "assets")]
  assets: Option<Vec<::models::ReleaseAssets>>,
...
impl ReleasesInner {
  ...
  pub fn set_assets(&mut self, assets: Vec<::models::ReleaseAssets>) {
    self.assets = Some(assets);
  }

  pub fn with_assets(mut self, assets: Vec<::models::ReleaseAssets>) -> ReleasesInner {
    self.assets = Some(assets);
    self
  }

  pub fn assets(&self) -> Option<&Vec<::models::ReleaseAssets>> {
    self.assets.as_ref()
  }
  ...
  pub fn set_assets_url(&mut self, assets_url: String) {
    self.assets_url = Some(assets_url);
  }

  pub fn with_assets_url(mut self, assets_url: String) -> ReleasesInner {
    self.assets_url = Some(assets_url);
    self
  }

  pub fn assets_url(&self) -> Option<&String> {
    self.assets_url.as_ref()
  }

  pub fn reset_assets_url(&mut self) {
  ...
  pub fn with_author(mut self, author: ::models::ComparecommitsBaseCommitAuthor) -> ReleasesInner {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_body(mut self, body: String) -> ReleasesInner {
    self.body = Some(body);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> ReleasesInner {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_draft(mut self, draft: bool) -> ReleasesInner {
    self.draft = Some(draft);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> ReleasesInner {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> ReleasesInner {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ReleasesInner {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_prerelease(mut self, prerelease: bool) -> ReleasesInner {
    self.prerelease = Some(prerelease);
    self
  }
  ...
  pub fn with_published_at(mut self, published_at: String) -> ReleasesInner {
    self.published_at = Some(published_at);
    self
  }
  ...
  pub fn with_tag_name(mut self, tag_name: String) -> ReleasesInner {
    self.tag_name = Some(tag_name);
    self
  }
  ...
  pub fn with_tarball_url(mut self, tarball_url: String) -> ReleasesInner {
    self.tarball_url = Some(tarball_url);
    self
  }
  ...
  pub fn with_target_commitish(mut self, target_commitish: String) -> ReleasesInner {
    self.target_commitish = Some(target_commitish);
    self
  }
  ...
  pub fn with_upload_url(mut self, upload_url: String) -> ReleasesInner {
    self.upload_url = Some(upload_url);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> ReleasesInner {
    self.url = Some(url);
    self
  }
  ...
  pub fn with_zipball_url(mut self, zipball_url: String) -> ReleasesInner {
    self.zipball_url = Some(zipball_url);
    self
  }
