...
impl Organization {
  ...
  pub fn with_blog(mut self, blog: String) -> Organization {
    self.blog = Some(blog);
    self
  }
  ...
  pub fn with_company(mut self, company: String) -> Organization {
    self.company = Some(company);
    self
  }
  ...
  pub fn with_followers(mut self, followers: i32) -> Organization {
    self.followers = Some(followers);
    self
  }
  ...
  pub fn with_following(mut self, following: i32) -> Organization {
    self.following = Some(following);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> Organization {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> Organization {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_login(mut self, login: String) -> Organization {
    self.login = Some(login);
    self
  }
  ...
  pub fn with_public_gists(mut self, public_gists: i32) -> Organization {
    self.public_gists = Some(public_gists);
    self
  }
  ...
  pub fn with_public_repos(mut self, public_repos: i32) -> Organization {
    self.public_repos = Some(public_repos);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> Organization {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> Organization {
    self.url = Some(url);
    self
  }
