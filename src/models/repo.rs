...
pub struct Repo {
  ...
  organization: Option<::models::RepoOrganization>,
  #[serde(rename = "owner")]
  owner: Option<::models::BranchCommitAuthor>,
  #[serde(rename = "parent")]
  parent: Option<::models::RepoParent>,
  ...
  size: Option<i32>,
  #[serde(rename = "source")]
  source: Option<::models::RepoSource>,
...
impl Repo {
  ...
  pub fn with_clone_url(mut self, clone_url: String) -> Repo {
    self.clone_url = Some(clone_url);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> Repo {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> Repo {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_fork(mut self, fork: bool) -> Repo {
    self.fork = Some(fork);
    self
  }
  ...
  pub fn with_forks(mut self, forks: i32) -> Repo {
    self.forks = Some(forks);
    self
  }
  ...
  pub fn with_forks_count(mut self, forks_count: i32) -> Repo {
    self.forks_count = Some(forks_count);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> Repo {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_git_url(mut self, git_url: String) -> Repo {
    self.git_url = Some(git_url);
    self
  }
  ...
  pub fn with_has_downloads(mut self, has_downloads: bool) -> Repo {
    self.has_downloads = Some(has_downloads);
    self
  }
  ...
  pub fn with_has_issues(mut self, has_issues: bool) -> Repo {
    self.has_issues = Some(has_issues);
    self
  }
  ...
  pub fn with_has_wiki(mut self, has_wiki: bool) -> Repo {
    self.has_wiki = Some(has_wiki);
    self
  }
  ...
  pub fn with_homepage(mut self, homepage: String) -> Repo {
    self.homepage = Some(homepage);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> Repo {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> Repo {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_language(mut self, language: String) -> Repo {
    self.language = Some(language);
    self
  }
  ...
  pub fn with_master_branch(mut self, master_branch: String) -> Repo {
    self.master_branch = Some(master_branch);
    self
  }
  ...
  pub fn with_mirror_url(mut self, mirror_url: String) -> Repo {
    self.mirror_url = Some(mirror_url);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> Repo {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_open_issues(mut self, open_issues: i32) -> Repo {
    self.open_issues = Some(open_issues);
    self
  }
  ...
  pub fn with_open_issues_count(mut self, open_issues_count: i32) -> Repo {
    self.open_issues_count = Some(open_issues_count);
    self
  }
  ...
  pub fn set_organization(&mut self, organization: ::models::RepoOrganization) {
    self.organization = Some(organization);
  }

  pub fn with_organization(mut self, organization: ::models::RepoOrganization) -> Repo {
    self.organization = Some(organization);
    self
  }

  pub fn organization(&self) -> Option<&::models::RepoOrganization> {
  ...
  pub fn with_owner(mut self, owner: ::models::BranchCommitAuthor) -> Repo {
    self.owner = Some(owner);
    self
  }
  ...
  pub fn set_parent(&mut self, parent: ::models::RepoParent) {
    self.parent = Some(parent);
  }

  pub fn with_parent(mut self, parent: ::models::RepoParent) -> Repo {
    self.parent = Some(parent);
    self
  }

  pub fn parent(&self) -> Option<&::models::RepoParent> {
    self.parent.as_ref()
  }
  ...
  pub fn with_private(mut self, private: bool) -> Repo {
    self.private = Some(private);
    self
  }
  ...
  pub fn with_pushed_at(mut self, pushed_at: String) -> Repo {
    self.pushed_at = Some(pushed_at);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> Repo {
    self.size = Some(size);
    self
  }
  ...
  pub fn set_source(&mut self, source: ::models::RepoSource) {
    self.source = Some(source);
  }

  pub fn with_source(mut self, source: ::models::RepoSource) -> Repo {
    self.source = Some(source);
    self
  }

  pub fn source(&self) -> Option<&::models::RepoSource> {
    self.source.as_ref()
  }
  ...
  pub fn with_ssh_url(mut self, ssh_url: String) -> Repo {
    self.ssh_url = Some(ssh_url);
    self
  }
  ...
  pub fn with_svn_url(mut self, svn_url: String) -> Repo {
    self.svn_url = Some(svn_url);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> Repo {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> Repo {
    self.url = Some(url);
    self
  }
  ...
  pub fn with_watchers(mut self, watchers: i32) -> Repo {
    self.watchers = Some(watchers);
    self
  }
  ...
  pub fn with_watchers_count(mut self, watchers_count: i32) -> Repo {
    self.watchers_count = Some(watchers_count);
    self
  }
