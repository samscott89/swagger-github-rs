...
impl CreateFileContent {
  pub fn new() -> CreateFileContent {
    CreateFileContent {
      _links: None,
      git_url: None,
      html_url: None,
  ...
  pub fn with__links(mut self, _links: ::models::ContentspathLinks) -> CreateFileContent {
    self._links = Some(_links);
    self
  }
  ...
  pub fn with_git_url(mut self, git_url: String) -> CreateFileContent {
    self.git_url = Some(git_url);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> CreateFileContent {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> CreateFileContent {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> CreateFileContent {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_sha(mut self, sha: String) -> CreateFileContent {
    self.sha = Some(sha);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> CreateFileContent {
    self.size = Some(size);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> CreateFileContent {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> CreateFileContent {
    self.url = Some(url);
    self
  }
