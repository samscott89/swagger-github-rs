...
pub struct SearchrepositoriesItems {
  ...
  #[serde(rename = "owner")]
  owner: Option<::models::SearchrepositoriesOwner>,
...
impl SearchrepositoriesItems {
  pub fn new() -> SearchrepositoriesItems {
    SearchrepositoriesItems {
      created_at: None,
      default_branch: None,
      description: None,
      fork: None,
  ...
  pub fn with_created_at(mut self, created_at: String) -> SearchrepositoriesItems {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_default_branch(mut self, default_branch: String) -> SearchrepositoriesItems {
    self.default_branch = Some(default_branch);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> SearchrepositoriesItems {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_fork(mut self, fork: bool) -> SearchrepositoriesItems {
    self.fork = Some(fork);
    self
  }
  ...
  pub fn with_forks(mut self, forks: i32) -> SearchrepositoriesItems {
    self.forks = Some(forks);
    self
  }
  ...
  pub fn with_forks_count(mut self, forks_count: i32) -> SearchrepositoriesItems {
    self.forks_count = Some(forks_count);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> SearchrepositoriesItems {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_homepage(mut self, homepage: String) -> SearchrepositoriesItems {
    self.homepage = Some(homepage);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> SearchrepositoriesItems {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> SearchrepositoriesItems {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_language(mut self, language: String) -> SearchrepositoriesItems {
    self.language = Some(language);
    self
  }
  ...
  pub fn with_master_branch(mut self, master_branch: String) -> SearchrepositoriesItems {
    self.master_branch = Some(master_branch);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SearchrepositoriesItems {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_open_issues(mut self, open_issues: i32) -> SearchrepositoriesItems {
    self.open_issues = Some(open_issues);
    self
  }
  ...
  pub fn with_open_issues_count(mut self, open_issues_count: i32) -> SearchrepositoriesItems {
    self.open_issues_count = Some(open_issues_count);
    self
  }
  ...
  pub fn set_owner(&mut self, owner: ::models::SearchrepositoriesOwner) {
    self.owner = Some(owner);
  }

  pub fn with_owner(mut self, owner: ::models::SearchrepositoriesOwner) -> SearchrepositoriesItems {
    self.owner = Some(owner);
    self
  }

  pub fn owner(&self) -> Option<&::models::SearchrepositoriesOwner> {
    self.owner.as_ref()
  }
  ...
  pub fn with_private(mut self, private: bool) -> SearchrepositoriesItems {
    self.private = Some(private);
    self
  }
  ...
  pub fn with_pushed_at(mut self, pushed_at: String) -> SearchrepositoriesItems {
    self.pushed_at = Some(pushed_at);
    self
  }
  ...
  pub fn with_score(mut self, score: f32) -> SearchrepositoriesItems {
    self.score = Some(score);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> SearchrepositoriesItems {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> SearchrepositoriesItems {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> SearchrepositoriesItems {
    self.url = Some(url);
    self
  }
  ...
  pub fn with_watchers(mut self, watchers: i32) -> SearchrepositoriesItems {
    self.watchers = Some(watchers);
    self
  }
  ...
  pub fn with_watchers_count(mut self, watchers_count: i32) -> SearchrepositoriesItems {
    self.watchers_count = Some(watchers_count);
    self
  }
