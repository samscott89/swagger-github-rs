...
impl RefsInner {
  ...
  pub fn with_object(mut self, object: ::models::HeadBranchObject) -> RefsInner {
    self.object = Some(object);
    self
  }
  ...
  pub fn with__ref(mut self, _ref: String) -> RefsInner {
    self._ref = Some(_ref);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> RefsInner {
    self.url = Some(url);
    self
  }
