...
impl RepoCommit {
  ...
  pub fn with_author(mut self, author: ::models::BranchCommitCommitAuthor) -> RepoCommit {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_committer(mut self, committer: ::models::BranchCommitCommitAuthor) -> RepoCommit {
    self.committer = Some(committer);
    self
  }
  ...
  pub fn with_parents(mut self, parents: Vec<::models::BranchCommitCommitTree>) -> RepoCommit {
    self.parents = Some(parents);
    self
  }
  ...
  pub fn with_sha(mut self, sha: String) -> RepoCommit {
    self.sha = Some(sha);
    self
  }
  ...
  pub fn with_tree(mut self, tree: ::models::BranchCommitCommitTree) -> RepoCommit {
    self.tree = Some(tree);
    self
  }
