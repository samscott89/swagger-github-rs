...
pub struct CreateFileCommit {
  ...
  parents: Option<Vec<::models::CreateFileCommitParents>>,
  #[serde(rename = "sha")]
  sha: Option<String>,
  #[serde(rename = "tree")]
...
impl CreateFileCommit {
  pub fn new() -> CreateFileCommit {
    CreateFileCommit {
      author: None,
      committer: None,
      html_url: None,
  ...
  pub fn with_author(mut self, author: ::models::ComparecommitsBaseCommitCommitAuthor) -> CreateFileCommit {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_committer(mut self, committer: ::models::ComparecommitsBaseCommitCommitAuthor) -> CreateFileCommit {
    self.committer = Some(committer);
    self
  }
  ...
  pub fn with_html_url(mut self, html_url: String) -> CreateFileCommit {
    self.html_url = Some(html_url);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> CreateFileCommit {
    self.message = Some(message);
    self
  }
  ...
  pub fn set_parents(&mut self, parents: Vec<::models::CreateFileCommitParents>) {
    self.parents = Some(parents);
  }

  pub fn with_parents(mut self, parents: Vec<::models::CreateFileCommitParents>) -> CreateFileCommit {
    self.parents = Some(parents);
    self
  }

  pub fn parents(&self) -> Option<&Vec<::models::CreateFileCommitParents>> {
    self.parents.as_ref()
  }
  ...
  pub fn with_sha(mut self, sha: String) -> CreateFileCommit {
    self.sha = Some(sha);
    self
  }
  ...
  pub fn with_tree(mut self, tree: ::models::BranchCommitCommitTree) -> CreateFileCommit {
    self.tree = Some(tree);
    self
  }
  ...
  pub fn with_url(mut self, url: String) -> CreateFileCommit {
    self.url = Some(url);
    self
  }
